...
- **Remote Workstations** — SSH and Docker execution environments per tenant with encrypted credentials, agent linking, permission allowlist with live cache invalidation, binary-only shell syntax guard, enable/disable toggle, and rolling audit logs
